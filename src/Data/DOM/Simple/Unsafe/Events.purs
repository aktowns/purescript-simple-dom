...
foreign import unsafeEventKeyCode :: forall eff. DOMEvent -> (Eff (dom :: DOM | eff) Number)

foreign import unsafeEventNumberProp :: forall eff. String -> DOMEvent -> (Eff (dom :: DOM | eff) Number)
